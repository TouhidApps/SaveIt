...
object SaveIt {
    ...
    private const val DEFAULT_SUFFIX = "_my_preferences"
    private const val LENGTH = "#LENGTH_"
    private lateinit var mPrefs: SharedPreferences
    private var isCommitEnabled = true


    private fun initPrefs(context: Context, prefsName: String, mode: Int, isCommitEnabled: Boolean) {

        mPrefs = context.getSharedPreferences(prefsName, mode)
        SaveIt.isCommitEnabled = isCommitEnabled
    ...
    class Builder {
        ...
        fun build() {
            ...
            initPrefs(mContext, mKey, mMode, isCommitEnabled)
        }
    }
}